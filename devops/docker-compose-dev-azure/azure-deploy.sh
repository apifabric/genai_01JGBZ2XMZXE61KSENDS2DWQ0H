...
resourcename="airportdatabase"  # lower case, only
resourcegroup="airportdatabase_rg"
...
# git clone https://github.com/apilogicserver/airportdatabase.git
# cd airportdatabase
...
az group create --name airportdatabase_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group airportdatabase_rg --sku S1 --is-linux
az container create --resource-group airportdatabase_rg --name airportdatabase --image apilogicserver/airportdatabase:latest --dns-name-label airportdatabase --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//airportdatabase.westus.azurecontainer.io:5656'
